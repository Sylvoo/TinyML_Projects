/**
  ...
  ******************************************************************************
  */
#ifndef AI_SINE_MODEL_OWN_H
#define AI_SINE_MODEL_OWN_H

#include "sine_model_own_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SINE_MODEL_OWN_MODEL_NAME          "sine_model_own"
#define AI_SINE_MODEL_OWN_ORIGIN_MODEL_NAME   "sine_model_quantized_1"

/******************************************************************************/
#define AI_SINE_MODEL_OWN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SINE_MODEL_OWN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SINE_MODEL_OWN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SINE_MODEL_OWN_IN_NUM        (1)

AI_DEPRECATED
#define AI_SINE_MODEL_OWN_IN \
  ai_sine_model_own_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SINE_MODEL_OWN_IN_SIZE { \
  AI_SINE_MODEL_OWN_IN_1_SIZE, \
}
#define AI_SINE_MODEL_OWN_IN_SIZE_BYTES { \
  AI_SINE_MODEL_OWN_IN_1_SIZE_BYTES, \
}
#define AI_SINE_MODEL_OWN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_MODEL_OWN_IN_1_CHANNEL     (1)
#define AI_SINE_MODEL_OWN_IN_1_SIZE        (1)
#define AI_SINE_MODEL_OWN_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SINE_MODEL_OWN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SINE_MODEL_OWN_OUT \
  ai_sine_model_own_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SINE_MODEL_OWN_OUT_SIZE { \
  AI_SINE_MODEL_OWN_OUT_1_SIZE, \
}
#define AI_SINE_MODEL_OWN_OUT_SIZE_BYTES { \
  AI_SINE_MODEL_OWN_OUT_1_SIZE_BYTES, \
}
#define AI_SINE_MODEL_OWN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_MODEL_OWN_OUT_1_CHANNEL     (1)
#define AI_SINE_MODEL_OWN_OUT_1_SIZE        (1)
#define AI_SINE_MODEL_OWN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SINE_MODEL_OWN_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup sine_model_own
 ...
 * @ref ai_sine_model_own_create. Both the activations memory buffer 
 ...
 * using @ref ai_sine_model_own_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sine_model_own_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sine_model_own_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SINE_MODEL_OWN_*
 * defines into file @ref sine_model_own.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sine_model_own_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SINE_MODEL_OWN_H */
